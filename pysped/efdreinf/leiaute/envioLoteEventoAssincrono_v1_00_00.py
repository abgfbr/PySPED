...
NAMESPACE_LOTE_EFDREINF = 'http://www.reinf.esocial.gov.br/schemas/envioLoteEventosAssincrono/v1_00_00'


class Evento(XMLNFe):
    def __init__(self):
        super(Evento, self).__init__()
        self.Id = TagCaracter(nome='evento', propriedade='Id',
                              raiz='//Reinf/loteEventos/evento',
...
class LoteEventoEFDReinf(XMLNFe):
    def __init__(self):
        ...
        self.caminho_esquema = os.path.join(DIRNAME, 'schema/',
                                            ESQUEMA_ATUAL + '/')
        self.arquivo_esquema = 'envioLoteEventosAssincrono-v1_00_00.xsd'
        self.id_evento = ''
