...
NAMESPACE_ESOCIAL = 'http://www.esocial.gov.br/schema/evt/evtFechaEvPer/v_S_01_02_00'
...
class InfoFech(XMLNFe):
    def __init__(self):
        ...
        self.evtPgtos        = TagCaracter(nome='evtPgtos', tamanho=[1, 1], raiz='//eSocial/evrFechaEvPer/evtPgtos', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False)
        ...
        self.indExcApur1250  = TagCaracter(nome='indExcApur1250',    tamanho=[1, 1], raiz='//eSocial/evrFechaEvPer/infoFech', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, obrigatorio=False)
        self.transDCTFWeb  = TagCaracter(nome='transDCTFWeb',    tamanho=[1, 1], raiz='//eSocial/evrFechaEvPer/infoFech', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, obrigatorio=False)
    ...
    def get_xml(self):
        ...
        xml += self.indExcApur1250.xml
        xml += self.transDCTFWeb.xml
        xml += '</infoFech>'
        return xml
...
class IdeEvento(XMLNFe):
    def __init__(self):
        ...
        self.indGuia = TagInteiro(nome='indGuia', tamanho=[1, 1], raiz='//eSocial/evtFechaEvPer/ideEvento', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, obrigatorio=False)
        ...
        self.procEmi     = TagInteiro( nome='procEmi',     tamanho=[1,  2], raiz='//eSocial/evtFechaEvPer/ideEvento', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, valor=1)
