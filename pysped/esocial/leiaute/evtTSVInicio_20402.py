...
NAMESPACE_ESOCIAL = 'http://www.esocial.gov.br/schema/evt/evtTSVInicio/v_S_01_03_00'
...
class InstEnsino(XMLNFe):
    def __init__(self):
        ...
        self.dscLograd = TagCaracter(nome='dscLograd', tamanho=[1, 10], raiz='//dscLograd', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, obrigatorio=False)
        self.nrLograd = TagCaracter(nome='nrLograd', tamanho=[1, 10], raiz='//nrLograd', namespace=NAMESPACE_ESOCIAL, namespace_obrigatorio=False, obrigatorio=False)
